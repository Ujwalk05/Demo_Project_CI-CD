...
public class LoginPage{
	...
	public String OrganizationSelection_RateAIcurrencyandformulaBtn = "//li[@class='organization']//button//span[contains(text(),'RateAI CurrencyAndFormula Automation')]";
	public String OrganizationSelection_RateAIcurrencyandformulaBtn_description = "Button for RateAI Automation org";
