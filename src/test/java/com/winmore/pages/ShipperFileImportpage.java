...
public class ShipperFileImportpage {
	...
	public String rowNumber = "//input[@placeholder='Enter row number']";
	...
	public String enterRowNumber = "//tr[@class='client-components-table-renderer-components-modal-upload-pricing-component-sheet-selection-__sheet-selection-module__selected']//input[@placeholder='Enter row number']/..//input";
	...
	public String proceedImportProceed = "//div[@class='client-components-table-renderer-components-modal-upload-pricing-component-__header-module__paddedContainer']//span[contains(text(),'Proceed')]";
	public String proceedImportProceed_Description = "Proceed button in price import modal header";
